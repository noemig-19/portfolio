...
function Header() {
  return (
    ...
    <header className="fixed top-4 p-2 left-8  bg-neutral-900/50  border border-neutral-700 rounded-2xl flex flex-col gap-4 max-lg:w-screen max-lg:top-0 max-lg:left-0 max-lg:pt-4 max-lg:border-b-0 max-lg:rounded-none max-[1186px]:hidden  max-lg:block">
