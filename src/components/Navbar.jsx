...
function Navbar() {
    ...
    return (
        <nav className="fixed top-4 left-0 right-0 z-50  ">
            <div className=" fixed right-2 p-2 bg-neutral-900/80 border border-neutral-700 w-16 rounded-2xl hidden max-md:block" onClick={toggleHamburger}><GiHamburgerMenu size={32} color="white"/></div>
            {/**desktop buttons */}
            <div className="max-w-150 flex gap-4 p-4 cursor-pointer bg-neutral-900/60 border border-neutral-700 text-white capitalize font-bold rounded-2xl max-md:hidden">
            ...
            {/**mobile bottons */}
            <div className={`${active ? "max-md:block" : "hidden"} z-8 fixed top-18 right-0 w-full p-6 bg-neutral-900 border border-neutral-700 text-white capitalize font-bold rounded-2xl`}>
                ...
                <li className=" hover:text-cyan-500 transition duration-300 py-2">contatto</li>
